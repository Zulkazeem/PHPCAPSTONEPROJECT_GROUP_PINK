...
<body>
	...
	<div class="container-signup">
		<div class="wrap-signup">
			...
			REGISTER <hr> CREATE AN ACCOUNT</span>
...
<div class="form-group">
                <label>Email</label>
                <input type="email" name="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>"placeholder="input valid email" >
          ...
          <center>   <div class="form-group">
                <input type="submit" class="primary-btn" value="Submit"><br>
                <input type="reset" class="secondary-btn" value="Reset">
            </div></center>
          <p>Own an account? <a href="index.php">Sign in</a>.</p>
        </form>
    </div>    
</div>
</div>
