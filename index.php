...
<div class="form-group">
  ...
  <input type="password" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>"value="<?php echo $username; ?>" placeholder="Enter Password">
...
<br> 
    <p>Your First Time? <a href="signup.php">Register Here</a>.</p>
        </form>
    </div>
</div>
</div>   
